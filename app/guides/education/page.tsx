...
export async function generateMetadata() {
  return {
    title: 'Education Guides - Baobab Nigeria',
    description: 'Step-by-step guides for education in Nigeria including WAEC/NECO exams, JAMB admission, scholarships, and NYSC.',
    keywords: ['education guides', 'WAEC', 'NECO', 'JAMB', 'scholarships', 'NYSC', 'university admission'],
  };
}

export default async function EducationGuidesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Education Guides</h1>
        <p className="text-gray-600">
          Complete step-by-step guides for education in Nigeria
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-2 mb-8">
        ...
        {subdomains.map((subdomain) => (
          <Link
            key={subdomain.id}
            href={`/guides/education?subdomain=${subdomain.slug}`}
      ...
      <div className="mt-12 p-6 bg-purple-50 rounded-lg">
        <div className="flex items-center justify-between">
          <div className="text-center">
            <div className="text-3xl font-bold text-purple-600">{guides.length}</div>
