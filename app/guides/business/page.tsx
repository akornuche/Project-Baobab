...
export async function generateMetadata() {
  return {
    title: 'Business Guides - Baobab Nigeria',
    description: 'Step-by-step guides for starting and running a business in Nigeria including registration, funding, taxation, and compliance.',
    keywords: ['business guides', 'starting a business', 'CAC registration', 'business loan', 'tax compliance'],
  };
}
...
export default async function BusinessGuidesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Business Guides</h1>
        <p className="text-gray-600">
          Complete step-by-step guides for starting and running a business in Nigeria
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-2 mb-8">
        ...
        {subdomains.map((subdomain) => (
          <Link
            key={subdomain.id}
            href={`/guides/business?subdomain=${subdomain.slug}`}
      ...
      <div className="mt-12 p-6 bg-green-50 rounded-lg">
        <div className="flex items-center justify-between">
          <div className="text-center">
            <div className="text-3xl font-bold text-green-600">{guides.length}</div>
