// Complete guide dataset for Baobab MVP
...
export const guidesData: GuideData[] = [
  // GOVERNMENT - Immigration & Travel
  {
    ...
    content: {
      ...
      overview: 'The UK offers several visa categories: visitor (tourist), work, study, family. Each has different requirements and processing times. Processing is done entirely online with biometric appointment at a VAC (Visa Application Centre).',
  ...
  // GOVERNMENT - Business Registration  
  {
    ...
    content: {
      quickAnswer: 'LLC registration with CAC takes 5-7 working days and costs ₦50,000-₦100,000. You need 2+ shareholders, a business name, registered office, and CAC forms. Processing is entirely online.',
